...
<section id=enroll-container>
	...
	<form id="memberUpdateFrm" method="post">
        ...
        <input type="button" name="btn" onclick="updateMember();" value="정보수정"/>
        <input type="button" name="btn" onclick="updatePassword();" value="비밀번호변경"/>
        <input type="button" name="btn" onclick="deleteMember();" value="탈퇴"/>
	</form>
</section>
